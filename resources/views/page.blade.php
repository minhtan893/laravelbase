...
@endsection
@section('script')
	<script type="text/javascript" src='{{ asset('js/comment-page.js') }}'></script>
@endsection
@section('content')
<div class="container wrapper">
  <div class="content">
    <div class="col-xs-12">
      <h5 class="display-5">{{ $page->title }}</h5>
      <p>by Admin</p>
      <hr>
      <input type="hidden" name="pageId" value="{{ $page->id}}" id='pageId'>
    </div>
    <div class="col-xs-12">
      ...
      {!! $page->content !!}
        ...
        <div class="col-xs-12 xs-offset-1">
          ...
          <form action="javascript:; " method="POST" class='comment-form'>
            ...
            <input type="hidden" name="postId" value='{{ null}}'>
